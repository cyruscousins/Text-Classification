...
namespace TextCharacteristicLearner
{
	public class ClassifierAccuracyAnalysis<Ty>
	{
		...
		public string latexAccuracyAnalysisString(){
			...
			result.AppendLine ("In these trials, the overall accuracy rate was found to be " + overallAccuracy.ToString (LatexExtensions.formatString) + ", which is " + Math.Abs (accuracyImprovement) + " " + ((accuracyImprovement > 0) ? "better" : "worse") + " than random choice (" + expectedAccuracyRandom.ToString (LatexExtensions.formatString) + ").");
